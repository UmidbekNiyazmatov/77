...
<template>
  <div class="bg-slate-50 h-20 mb-24 w-full">
    <div class="container flex w-full max-sm:px-2">
      ...
      <router-link to="/">
        <div class="bg-white p-5 rounded-b-2xl max-sm:w-[150px] max-sm:px-3 max-md:w-[200px]  " style="transform: translateY(-90px)">
          ...
          >
            ...
            />
            <path
              d="M41.424 27.636L30.516 48.66H24L33.864 29.76H24V24H41.424V27.636Z"
              fill="white"
            />
            <path
              d="M61.8146 27.636L50.9066 48.66H44.3906L54.2546 29.76H44.3906V24H61.8146V27.636Z"
              fill="white"
            />
            <path
